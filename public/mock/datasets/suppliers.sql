...
INSERT INTO suppliers (supplierID, companyName, contactName, contactTitle, address, city, region, postalCode, country, phone, fax, homePage) VALUES
	...
	('12', 'Plutzer Lebensmittelgroßmärkte AG', 'Martin Bein', 'International Marketing Mgr.', 'Bogenallee 51', 'Frankfurt', NULL, '60439', 'Germany', '(069) 992755', NULL, 'Plutzer (on the World Wide Web)'),
	...
	('24', 'Gday Mate', 'Wendy Mackenzie', 'Sales Representative', '170 Prince Edward Parade Hunters Hill', 'Sydney', 'NSW', '2042', 'Australia', '(02) 555-5914', '(02) 555-4873', 'Gday Mate (on the World Wide Web)'),
